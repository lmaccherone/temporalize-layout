...
var Circle, Line, LineSeries, Rect, Tag, delay, rootAttributes,
...
Circle = (function(superClass) {
  ...
  function Circle(cx, cy, r, tagAttributes, parent) {
    var key, ref, value;
    this.tagAttributes = tagAttributes != null ? tagAttributes : {};
    this.parent = parent != null ? parent : null;
    this.tagAttributes.cx = cx + "%";
    this.tagAttributes.cy = cy + "%";
    this.tagAttributes.r = "" + r;
    if (Circle.defaultAttributes != null) {
      ref = Circle.defaultAttributes;
      for (key in ref) {
        value = ref[key];
        this.tagAttributes[key] = value;
      }
    }
    return Circle.__super__.constructor.call(this, 'circle', this.tagAttributes, this.parent);
  }

  Circle.setDefaultAttributes = function(newOrOverideAttributes) {
    var key, results, value;
    results = [];
    for (key in newOrOverideAttributes) {
      value = newOrOverideAttributes[key];
